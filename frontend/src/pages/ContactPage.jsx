...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Simulação de envio de mensagem (em produção, substituir por chamada à API)
    ...
    <div className="page-container">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 lg:col-span-1">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">contato@animalrescuehub.com.br</p>
              </div>
            </div>
          ...
          <div className="mt-8">
            <h3 className="font-medium mb-3">Nossas Redes Sociais</h3>
